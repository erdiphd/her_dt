...
parser.add_argument("--episode_len", default=200, type=int, help="The max length of an episode in timesteps")
...
logdir = "ge_q_dts/logs/gym/{}_{}".format(date, "".join(np.random.choice(list(string.ascii_lowercase), size=10)))
