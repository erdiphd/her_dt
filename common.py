...
def get_args():
	...
	parser.add_argument('--learn', help='type of training method', type=str, default='hgg_dt', choices=learner_collection.keys())
	...
	'affects number of goals: 0.1 -> 2, 0.00075 -> 400', type=np.float32, default=0.02)
