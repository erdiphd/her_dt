	...
	#             out=1""")
		...
		for epoch in range(args.epochs):
			for cycle in range(args.cycles):
				...
				list_of_current_arm_position = learner.learn(args, env, env_test, agent, buffer, list_of_phenotypes, list_of_arm, list_of_goal, num_dim, list_of_third_coordinate, list_of_current_arm_position)
